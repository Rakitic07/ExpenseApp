export default function Background() {
  return (
    <div className="app-bg pointer-events-none fixed inset-0 -z-10 overflow-hidden">
       ...
       */}
      <div className="bg-blob absolute -left-24 top-[-6rem] h-[26rem] w-[26rem] rounded-full bg-[#7c8cff]/25 blur-[80px]" />
      <div className="bg-blob absolute right-[-8rem] top-24 h-[24rem] w-[24rem] rounded-full bg-[#ff6bd0]/20 blur-[80px]" />
      <div className="bg-blob absolute bottom-[-10rem] left-1/3 h-[26rem] w-[26rem] rounded-full bg-[#38d9a9]/15 blur-[90px]" />
